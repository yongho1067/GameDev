...
IL_0072:
	{
		// startFillAmount = Mathf.MoveTowards(startFillAmount, targetFillAmount, fillSpeed * Time.deltaTime);
...
IL_0038:
	{
		...
		GameSession_t01C53B6EB975CC4025A3484995B36C45BBA800C9 * L_10 = V_1;
		NullCheck(L_10);
		Image_t4021FF27176E44BFEDDCBE43C7FE6B713EC70D3C * L_11 = L_10->get_panelimage_9();
		NullCheck(L_11);
		Image_set_fillAmount_m1D28CFC9B15A45AB6C561AA42BD8F305605E9E3C(L_11, (0.0f), /*hidden argument*/NULL);
		// }
		return (bool)0;
	}
}
